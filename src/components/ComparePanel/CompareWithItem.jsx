...
export const CompareWithItem = (props) => {
    ...
    const productMeasures = measures(props.product, compareWithItemCalculations.product.size, props.measurement);
    const itemMeasures = measures(props.item, compareWithItemCalculations.item.size, props.measurement);
    return (
